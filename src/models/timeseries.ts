import { ChronoLocalDateTime, ChronoUnit, Duration, Instant, LocalDate, Period, Temporal, TemporalAccessor, TemporalUnit } from "@js-joda/core"
...
function dateHistogram<T>(
    ...
    const maxDate = key(sorted[sorted.length - 1])
    // const bucketCount = interval.between(minDate, maxDate) + 1
